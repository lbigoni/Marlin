...
#define STRING_CONFIG_H_AUTHOR "(SPICA Lab, TEVO Tarantula config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SPICA 3D Printer"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "eb36b08d-c635-4aec-bb60-f1a4daa09e44"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //from pidautotune
  #define DEFAULT_bedKp 380.37
  #define DEFAULT_bedKi 67.29
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 415, 415 }
...
/**
 * Added for Does the math to set probe points determined by nozzle,
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the boundaries for probing (where the probe can reach).
  #define MIN_PROBE_EDGE_LEFT PROBE_X_LEFT
  #define MIN_PROBE_EDGE_RIGHT PROBE_X_RIGHT
  #define MIN_PROBE_EDGE_FRONT PROBE_Y_FRONT
  #define MIN_PROBE_EDGE_BACK PROBE_Y_BACK
...
//#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_Z_HOP  10  // (mm) Move nozzle up before moving between corners
