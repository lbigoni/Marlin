...
#define STRING_CONFIG_H_AUTHOR "(Luca Bigoni, SPICALABS 3d Printer EasyConfig)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SPICALABS 3D Printer"
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 87  // Y offset: -front +behind [the nozzle]
